...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //Add a marker - using the location coordinates
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Incorrect email and password');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error while logging out try agian');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(data, type); //type is 'password' or 'data'
            //updateMyPassword
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Sign Up Successfully Please Confirm Your Account Via Email');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var selectStartDate = document.querySelector('.selectStartDate');
var reviewBtn = document.querySelector('.btn--review');
var reviewSave = document.querySelector('.review-save');
var closeReview = document.querySelector('.close'); //const confirmBtn = document.getElementById('token-log');
//Delegation
...
if (accountForm) {
  accountForm.addEventListener('submit', function (e) {
    e.preventDefault(); //set multipart form data
